...
def daily_news():
  ...
  john.home()
  john.right(90)
  story = "Today's story is about the Zanderman News Poll."
  john.write(story, font=style2, align='center')
  wn.bgcolor('lightblue')
  john.hideturtle()
  john.forward(50)
  style3=('normal', 10, 'bold')
  report = "The official results from the first Zanderman News Poll Came out today. It seems most people like to name their turtles randomly. Many people name their turtles the first thing that comes to mind. '\n' If you would like a randomly generated turtle name, go to post number 8 on the Zanderman News Interview with the Public thread."
...
def tiger_jokes():
  ...
  john.write("Why does Python live on land?", font = style5,align='center')
  john.forward(100)
  john.write("Because it's above C-level.", font = style5, align='center')
  time.sleep(5)
  undo(20, john)
...
def COVID_19():
  #intro
   ...
   john.right(180)
   john.forward(80)
   john.write("Total cases: 9.24M", font = style, align = 'center')
   john.forward(80)
   john.write("Total recovered: 4.61M", font = style, align = 'center')
   john.forward(80)
   john.write("Total deaths: 477K", font = style, align = 'center')
   time.sleep(5)
   undo(30, john) 
   john.left(90)
   john.penup()
   john.forward(100)
   john.write("Total U.S. cases: 2.39M", font = style, align ='center')
   john.right(180)
   john.forward(50)
   john.write("Total U.S. recoveries: 740K", font = style, align ='center')
   john.forward(50)
   ...
   john.penup()
   john.forward(100)
   john.write("Total Canadian cases: 101,963", font=style, align='center')
   john.right(180)
   john.forward(50)
   john.write("Total Canadian recoveries: 64,704", font=style, align='center')
   john.forward(50)
   john.write("Total Canadian Deaths: 8,454", font=style, align='center')
   time.sleep(5)
   undo(42,john)
...
channel = input("What channel do you want to watch? Please input 1, 2, 3, 4, 5, or 6. If you would like to watch all the channels, please input anything else. ")
if channel=='1':
  channel_one()
  daily_news()
elif channel == '2':
